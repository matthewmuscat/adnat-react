      ...
      if(this.state.editing) {
        return(
          <center>
            ...
            >
              <br />
              Name: <input type="text" id="name" name="name" value={this.state.name}
            onChange={this.handleTextInput} /><br/><br/>
              Hourly Rate: $<input type="number" name="hourlyRate" value={this.state.hourlyRate}
            onChange={this.handleTextInput}/>
        ...
        return(
          <center>
            <div>
              <h2>Summary {this.state.organisationName ? (<span>of {this.state.organisationName}</span>) : (<span></span>)}</h2>
              <br />
